...
#getHardwareID                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       = str(check_output('wmic csproduct get uuid')).split('\\r\\n')[1].strip('\\r').strip()
#hwid2 = "DIAMOND-" + getHardwareID

# ----------------------------------------------- #

#HWID_LINK = "https://pastebin.com/xxxxxx"

# ----------------------------------------------- #

#def checking():
	#hardwareIDContent = str(get(HWID_LINK).text)
	#sleep(2)
	#if (hwid2 in hardwareIDContent):
		#return True
	#return False
...
def CNP():
    ...
    def trueh():
        try:
            ...
            print(f"[{Fore.GREEN}+{Fore.RESET}]{Fore.GREEN} {phone[:5]}*****{Fore.RESET}")
        except:pass
...
if __name__ == "__main__":
    ...
    sleep(0.5)
    #antihwidbasic()
    #print(f'{Fore.CYAN}Check HWID. . .{Fore.RESET}')
    #if (checking() != True):
        #print(f'{Fore.BLUE}[LOG]{Fore.RESET}{Fore.RED} HWID{Fore.RESET} : {Fore.GREEN}DIAMOND-{getHardwareID}{Fore.RESET}')
        #input()
        #exit()
    #print(f'{Fore.BLUE}[LOG]{Fore.RESET} {Fore.GREEN}SUCCSS HWID HAS BEEN SAVE!!{Fore.RESET}')
    #sleep(0.5)
    #system("cls || clear")
    AOC.start()